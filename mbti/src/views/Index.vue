<template>
    <div class="container">
        <div class="part-1 parallax">
            <div class="text left-text" ref="leftText">MBTI与宫崎骏 </div>
            <div class="text right-text" ref="rightText">永恒飞翔的少男少女之梦</div>
        </div>
       

        <div class="part-3 parallax">
            <h1>正如宫崎骏的作品中所描绘的那样，不同个性类型的人们都有自己独特的梦想和使命<br>他们都在自己的领域里飞翔，追逐着那片属于自己的蓝天<br>
                在MBTI与宫崎骏的交汇点，我们看到了人性的复杂性和多样性<br>也看到每个人都有潜力去改变自己和这个世界的力量<br>
                 这些永恒的梦想和情感，将永远激发着我们内心的火花<br>让我们坚信，只要心怀梦想，我们也可以像那些少男少女一样
                 <br>永远飞翔在自己的梦想之中</h1>
        </div>
        ...
        <div class="part-2" :style="{ backgroundColor: bgColor }">
            ...
            <div class="right">
                <MagicCard :img="imgUrl" :detailText="currentText" :key="highlightedIndex" />
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            texts: [
                ...
                "Entp：哈尔。哈尔总是可以以乐观幽默的态度快速解决问题，同时他也热爱探索，喜欢自由，也能对周围的环境作出即时的反应",
    ...
    computed: {
        imgUrl() {
            ...
            return require(`../assets/image/${imageIndex}.png`);
        },
                currentText() {
    ...
    methods: {
        ...
        createParallaxEffect() {
            gsap.to(this.$refs.leftText, {
                x: 600,
                scrollTrigger: {
                    trigger: this.$refs.leftText,
                    scrub: true,
                },
            });

            gsap.to(this.$refs.rightText, {
                x: -500,
                scrollTrigger: {
                    trigger: this.$refs.rightText,
                    scrub: true,
                },
            });
        },
...
.container {
    ...
    .part-1 {
        ...
        align-items: center;
        background: url(../assets/image/bg-1.gif) center center / cover no-repeat
            fixed;
        .text {
            position: absolute;
            font-size: 5em;
